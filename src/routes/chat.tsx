...
export const Route = createFileRoute('/chat')({ component: FullChatApp })
                  ...
                  {isAssistant ? (
                    <div className="flex gap-2">
                      ...
                      <div className="group flex w-full flex-col gap-0">
                        <MessageContent
                          className="text-foreground prose-h2:mt-0! prose-h2:scroll-m-0! dark:prose-invert flex-1 rounded-lg bg-transparent p-0"
                          markdown
                        >
                          {message.content}
                        </MessageContent>
                    ...
                    <div className="group flex flex-col items-end gap-1">
                      <MessageAvatar
                        ...
                        alt="Ibelick"
                      />
                      <MessageContent className="bg-muted text-foreground prose-h2:mt-0! prose-h2:scroll-m-0! dark:prose-invert max-w-full rounded-3xl px-5 py-2.5 sm:max-w-[75%]">
                        {message.content}
                      </MessageContent>
                      <MessageActions
                        className={cn(
          ...
          >
            <div className="flex flex-col">
              <PromptInputTextarea
                ...
                className="min-h-11 text-foreground pt-3 pl-4 text-base leading-[1.3] sm:text-base md:text-base prose-h2:mt-0! prose-h2:scroll-m-0! dark:prose-invert"
              />
